...
![Capture CP9 - Lobby indisponible](assets/images/Screenshot%202026-03-26%20at%2016.23.03.png)

Un MFE qui crash n'arrête pas les autres parce que chaque micro-frontend est isolé (processus/bundle/serveur indépendant) et chargé dynamiquement par le shell, donc la panne de l’un n’arrête pas l’exécution des autres.
